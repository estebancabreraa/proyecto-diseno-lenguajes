#Scanner created with ArchivoPrueba2.ATG data
...
tabulador= 'tabulador'
temp = AFD(tabulador)
temptabuladorAcceptance = {0: False, 1: True}

temp.setDictAcceptance(temptabuladorAcceptance)
temptabuladorTransitions = {0: {1: [{9}]}, 1: {}}

temp.setTransition(temptabuladorTransitions)
adfArray.append(temp)
temp = ''
name = ""
previousName = ''
...
found = False
tokensFound = []
f = open("ArchivoPrueba2Entrada.txt", "r")
text = f.read()
for i in text:
    temp = temp + i
