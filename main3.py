...
less_word = ""
less_number = 0
characters_elementos = save_groups("SumList.atg", "CHARACTERS", "TOKENS\n")
...
keywords_string = ""
keywords_words = []
keywords_elementos = save_groups("SumList.atg", "KEYWORDS\n", "TOKENS")
...
# seguimos con tokens
tokens_elementos = save_groups("SumList.atg", "TOKENS", "PRODUCTIONS")
tokens_array = []
...
f = open("SumList.atg", "r")
key = False
productions_elementos = ""
for line in f:
    if "END ArchivoPrueba1" in line:
        key = False
    if key == True:
...
# Aqui bu mos elementos, los cuales estan declarados en llaves. Busca elementos entre llaves.
# Quita los simbolos que estan entre comillas para guardarlos.
symbol = ""
symbol_key = False
symbol_key_2 = 0
...
#Definimos los ciclos que recorreran los arreglos de elementos.
...
#Guardan strings para concatenar.
bucket = ""
bucket_2 = ""
bucket_3 = ""
bucket_3_1 = ""
...
for i in productions_elementos:
    ...
    #Recorremos las definiciones de funciones y hacemos los respectivos replace de caracteres
    #para adecuarlas a la sintaxis de python.
